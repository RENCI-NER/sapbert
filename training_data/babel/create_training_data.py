...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file_name_1', type=str,
                        default='/projects/babel/sapbert-training/2022oct13/compendia/AnatomicalEntity.txt',
    ...
    parser.add_argument('--input_file_name_2', type=str,
                        default='/projects/babel/sapbert-training/2022oct13/compendia/GrossAnatomicalStructure.txt',
